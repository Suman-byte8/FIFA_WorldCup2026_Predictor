  ...
  return (
    <>
      ...
      >
        ...
        {/* ── FOOTER ──────────────────────────────────────────────── */}
        <footer style={{ marginTop: "auto", paddingTop: "40px", textAlign: "center", color: C.muted, fontSize: "12px", display: "flex", flexDirection: "column", gap: "8px", alignItems: "center" }}>
          <p style={{ margin: 0 }}>
            Developed by <strong>Suman Saha</strong> using Poisson regression and datasets.
          </p>
          <div style={{ display: "flex", gap: "16px", alignItems: "center", marginTop: "4px" }}>
            <a href="https://github.com/Suman-byte8" target="_blank" rel="noreferrer" style={{ color: C.muted, display: "flex", alignItems: "center", gap: "6px", textDecoration: "none", transition: "color 0.2s" }} onMouseOver={(e) => e.currentTarget.style.color = C.text} onMouseOut={(e) => e.currentTarget.style.color = C.muted}>
            ...
            <a href="https://sumancodes.netlify.app" target="_blank" rel="noreferrer" style={{ color: C.muted, display: "flex", alignItems: "center", gap: "6px", textDecoration: "none", transition: "color 0.2s" }} onMouseOver={(e) => e.currentTarget.style.color = C.text} onMouseOut={(e) => e.currentTarget.style.color = C.muted}>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
